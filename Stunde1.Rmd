...
![](images/R-einstellungen.png)
Zwei wichtige Einstellungen sind (unserer Meinung nach) den Haken bei "Restore .RData into workspace at start-up" zu entfernen und die Option bei "Save workspace to .RData on exit" auf "Never" zu setzen. In einzelfällen kann es sinnvoll sein, Daten und Zuweisungen aus der letzten Sitzung automatisch in der nächsten Sitzung zu laden. In vielen Fällen kann dies aber zu Verwirrung oder sogar zu Fehlern führen. 
