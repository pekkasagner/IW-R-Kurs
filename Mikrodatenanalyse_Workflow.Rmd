...
Der Umgang mit Häufigkeitsgewichten ist in <code>R</code> etwas anders als in anderen

```{r}
# arbeitsdatensatz %>%
#   filter(jahr == 2004) %>%
#   mutate(test = sum(income*weight)/sum(weight)) %>%
#   mutate(test2 = weighted.mean(income, w = weight))
```
